...
gcc -pthread -shared -L/opt/anaconda3/lib -B /opt/anaconda3/compiler_compat -Wl,-rpath=/opt/anaconda3/lib -Wl,--no-as-needed -Wl,--sysroot=/ build/temp.linux-x86_64-3.5/mul.o -L/opt/anaconda3/lib -lpython3.5m -o /home/yan/MNIST_CNN/hipsternet/ops/mul.cpython-35m-x86_64-linux-gnu.so -fopenmp
