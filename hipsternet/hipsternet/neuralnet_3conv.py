...
class ConvNet(NeuralNet):
    ...
    def __init__(self, D, C, H, lam=1e-3, p_dropout=.8, loss='cross_ent', nonlin='relu',conv_1=0, conv_2=0, FC_1=0, FC_2=0):
        super().__init__(D, C, H, lam, p_dropout, loss, nonlin)
        self.conv_1 = conv_1
        self.conv_2 = conv_2
        self.FC_1 = FC_1
    ...
    def forward(self, X, train=False):
        ...
        # Padding
        h_pool2 = np.insert(h_pool2, 7, 0, axis=2)
        h_pool2 = np.insert(h_pool2, 7, 0, axis=3)
    ...
    def _init_model(self, D, C, H):
        ...
        # for 2conv
        self.model = dict(
            W_conv1=np.load("data/model_5/weight/hipsternet/w_conv1.npy"),
            b_conv1=np.load("data/model_5/weight/hipsternet/b_conv1.npy"),
            W_conv2=np.load("data/model_5/weight/hipsternet/w_conv2.npy"),
            b_conv2=np.load("data/model_5/weight/hipsternet/b_conv2.npy"),
            W_fc1  =np.load("data/model_5/weight/hipsternet/w_fc1.npy"),
            b_fc1  =np.load("data/model_5/weight/hipsternet/b_fc1.npy"),
            W_fc2  =np.load("data/model_5/weight/hipsternet/w_fc2.npy"),
            b_fc2  =np.load("data/model_5/weight/hipsternet/b_fc2.npy")
        )
