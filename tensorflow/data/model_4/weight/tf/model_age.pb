...
node {
  name: "gradients/y_conv_tmp_grad/Shape"
  op: "Shape"
  input: "MatMul_1"
  attr {
    key: "T"
...
node {
  name: "gradients/y_conv_tmp_grad/Shape_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/y_conv_tmp_grad/BroadcastGradientArgs"
  op: "BroadcastGradientArgs"
  input: "gradients/y_conv_tmp_grad/Shape"
  input: "gradients/y_conv_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/y_conv_tmp_grad/Sum"
  op: "Sum"
  input: "gradients/y_conv_grad/mul_1"
  input: "gradients/y_conv_tmp_grad/BroadcastGradientArgs"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/y_conv_tmp_grad/Reshape"
  op: "Reshape"
  input: "gradients/y_conv_tmp_grad/Sum"
  input: "gradients/y_conv_tmp_grad/Shape"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/y_conv_tmp_grad/Sum_1"
  op: "Sum"
  input: "gradients/y_conv_grad/mul_1"
  input: "gradients/y_conv_tmp_grad/BroadcastGradientArgs:1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/y_conv_tmp_grad/Reshape_1"
  op: "Reshape"
  input: "gradients/y_conv_tmp_grad/Sum_1"
  input: "gradients/y_conv_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/y_conv_tmp_grad/tuple/group_deps"
  op: "NoOp"
  input: "^gradients/y_conv_tmp_grad/Reshape"
  input: "^gradients/y_conv_tmp_grad/Reshape_1"
}
node {
  name: "gradients/y_conv_tmp_grad/tuple/control_dependency"
  op: "Identity"
  input: "gradients/y_conv_tmp_grad/Reshape"
  input: "^gradients/y_conv_tmp_grad/tuple/group_deps"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/y_conv_tmp_grad/Reshape"
      }
    }
  }
}
node {
  name: "gradients/y_conv_tmp_grad/tuple/control_dependency_1"
  op: "Identity"
  input: "gradients/y_conv_tmp_grad/Reshape_1"
  input: "^gradients/y_conv_tmp_grad/tuple/group_deps"
  attr {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/y_conv_tmp_grad/Reshape_1"
      }
    }
  }
}
node {
  ...
  op: "MatMul"
  input: "gradients/y_conv_tmp_grad/tuple/control_dependency"
  input: "w_fc2/read"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_fc1_tmp_grad/Shape"
  op: "Shape"
  input: "MatMul"
  attr {
    key: "T"
...
node {
  name: "gradients/h_fc1_tmp_grad/Shape_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/h_fc1_tmp_grad/BroadcastGradientArgs"
  op: "BroadcastGradientArgs"
  input: "gradients/h_fc1_tmp_grad/Shape"
  input: "gradients/h_fc1_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/h_fc1_tmp_grad/Sum"
  op: "Sum"
  input: "gradients/h_fc1_grad/ReluGrad"
  input: "gradients/h_fc1_tmp_grad/BroadcastGradientArgs"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_fc1_tmp_grad/Reshape"
  op: "Reshape"
  input: "gradients/h_fc1_tmp_grad/Sum"
  input: "gradients/h_fc1_tmp_grad/Shape"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_fc1_tmp_grad/Sum_1"
  op: "Sum"
  input: "gradients/h_fc1_grad/ReluGrad"
  input: "gradients/h_fc1_tmp_grad/BroadcastGradientArgs:1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_fc1_tmp_grad/Reshape_1"
  op: "Reshape"
  input: "gradients/h_fc1_tmp_grad/Sum_1"
  input: "gradients/h_fc1_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_fc1_tmp_grad/tuple/group_deps"
  op: "NoOp"
  input: "^gradients/h_fc1_tmp_grad/Reshape"
  input: "^gradients/h_fc1_tmp_grad/Reshape_1"
}
node {
  name: "gradients/h_fc1_tmp_grad/tuple/control_dependency"
  op: "Identity"
  input: "gradients/h_fc1_tmp_grad/Reshape"
  input: "^gradients/h_fc1_tmp_grad/tuple/group_deps"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/h_fc1_tmp_grad/Reshape"
      }
    }
  }
}
node {
  name: "gradients/h_fc1_tmp_grad/tuple/control_dependency_1"
  op: "Identity"
  input: "gradients/h_fc1_tmp_grad/Reshape_1"
  input: "^gradients/h_fc1_tmp_grad/tuple/group_deps"
  attr {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/h_fc1_tmp_grad/Reshape_1"
      }
    }
  }
}
node {
  ...
  op: "MatMul"
  input: "gradients/h_fc1_tmp_grad/tuple/control_dependency"
  input: "w_fc1/read"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_conv2_tmp_grad/Shape"
  op: "Shape"
  input: "conv2d2"
  attr {
    key: "T"
...
node {
  name: "gradients/h_conv2_tmp_grad/Shape_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/h_conv2_tmp_grad/BroadcastGradientArgs"
  op: "BroadcastGradientArgs"
  input: "gradients/h_conv2_tmp_grad/Shape"
  input: "gradients/h_conv2_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/h_conv2_tmp_grad/Sum"
  op: "Sum"
  input: "gradients/h_conv2_grad/ReluGrad"
  input: "gradients/h_conv2_tmp_grad/BroadcastGradientArgs"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_conv2_tmp_grad/Reshape"
  op: "Reshape"
  input: "gradients/h_conv2_tmp_grad/Sum"
  input: "gradients/h_conv2_tmp_grad/Shape"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_conv2_tmp_grad/Sum_1"
  op: "Sum"
  input: "gradients/h_conv2_grad/ReluGrad"
  input: "gradients/h_conv2_tmp_grad/BroadcastGradientArgs:1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_conv2_tmp_grad/Reshape_1"
  op: "Reshape"
  input: "gradients/h_conv2_tmp_grad/Sum_1"
  input: "gradients/h_conv2_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_conv2_tmp_grad/tuple/group_deps"
  op: "NoOp"
  input: "^gradients/h_conv2_tmp_grad/Reshape"
  input: "^gradients/h_conv2_tmp_grad/Reshape_1"
}
node {
  name: "gradients/h_conv2_tmp_grad/tuple/control_dependency"
  op: "Identity"
  input: "gradients/h_conv2_tmp_grad/Reshape"
  input: "^gradients/h_conv2_tmp_grad/tuple/group_deps"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/h_conv2_tmp_grad/Reshape"
      }
    }
  }
}
node {
  name: "gradients/h_conv2_tmp_grad/tuple/control_dependency_1"
  op: "Identity"
  input: "gradients/h_conv2_tmp_grad/Reshape_1"
  input: "^gradients/h_conv2_tmp_grad/tuple/group_deps"
  attr {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/h_conv2_tmp_grad/Reshape_1"
      }
    }
  }
}
...
node {
  ...
  input: "w_conv2/read"
  input: "gradients/h_conv2_tmp_grad/tuple/control_dependency"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_conv1_tmp_grad/Shape"
  op: "Shape"
  input: "conv2d1"
  attr {
    key: "T"
...
node {
  name: "gradients/h_conv1_tmp_grad/Shape_1"
  op: "Const"
  attr {
    key: "dtype"
    value {
...
node {
  name: "gradients/h_conv1_tmp_grad/BroadcastGradientArgs"
  op: "BroadcastGradientArgs"
  input: "gradients/h_conv1_tmp_grad/Shape"
  input: "gradients/h_conv1_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
      type: DT_INT32
...
node {
  name: "gradients/h_conv1_tmp_grad/Sum"
  op: "Sum"
  input: "gradients/h_conv1_grad/ReluGrad"
  input: "gradients/h_conv1_tmp_grad/BroadcastGradientArgs"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_conv1_tmp_grad/Reshape"
  op: "Reshape"
  input: "gradients/h_conv1_tmp_grad/Sum"
  input: "gradients/h_conv1_tmp_grad/Shape"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_conv1_tmp_grad/Sum_1"
  op: "Sum"
  input: "gradients/h_conv1_grad/ReluGrad"
  input: "gradients/h_conv1_tmp_grad/BroadcastGradientArgs:1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  name: "gradients/h_conv1_tmp_grad/Reshape_1"
  op: "Reshape"
  input: "gradients/h_conv1_tmp_grad/Sum_1"
  input: "gradients/h_conv1_tmp_grad/Shape_1"
  attr {
    key: "T"
    value {
...
node {
  name: "gradients/h_conv1_tmp_grad/tuple/group_deps"
  op: "NoOp"
  input: "^gradients/h_conv1_tmp_grad/Reshape"
  input: "^gradients/h_conv1_tmp_grad/Reshape_1"
}
node {
  name: "gradients/h_conv1_tmp_grad/tuple/control_dependency"
  op: "Identity"
  input: "gradients/h_conv1_tmp_grad/Reshape"
  input: "^gradients/h_conv1_tmp_grad/tuple/group_deps"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/h_conv1_tmp_grad/Reshape"
      }
    }
  }
}
node {
  name: "gradients/h_conv1_tmp_grad/tuple/control_dependency_1"
  op: "Identity"
  input: "gradients/h_conv1_tmp_grad/Reshape_1"
  input: "^gradients/h_conv1_tmp_grad/tuple/group_deps"
  attr {
  ...
  attr {
    ...
    value {
      list {
        s: "loc:@gradients/h_conv1_tmp_grad/Reshape_1"
      }
    }
  }
}
...
node {
  ...
  input: "w_conv1/read"
  input: "gradients/h_conv1_tmp_grad/tuple/control_dependency"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  input: "Adam/beta2"
  input: "Adam/epsilon"
  input: "gradients/h_conv1_tmp_grad/tuple/control_dependency_1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  input: "Adam/beta2"
  input: "Adam/epsilon"
  input: "gradients/h_conv2_tmp_grad/tuple/control_dependency_1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  input: "Adam/beta2"
  input: "Adam/epsilon"
  input: "gradients/h_fc1_tmp_grad/tuple/control_dependency_1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
...
node {
  ...
  input: "Adam/beta2"
  input: "Adam/epsilon"
  input: "gradients/y_conv_tmp_grad/tuple/control_dependency_1"
  attr {
    key: "T"
    value {
      type: DT_FLOAT
